...
namespace command_line
{
  ...
  const arg_descriptor<std::string>   arg_block_relay_url("block-relay-url", "Override base URL used to submit PoS blocks when --enable-block-socks5-relay-proxy is set (e.g. http://37.27.100.59:10505)", "");
