...
namespace currency
{
  ...
  std::string get_account_address_and_payment_id_as_str(const gateway_address_target& addr, const payment_id_t& payment_id = payment_id_t());
  std::string get_account_address_and_payment_id_as_str(const address_v& addr, const payment_id_t& payment_id = payment_id_t());
