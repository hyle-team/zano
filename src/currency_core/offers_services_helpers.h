...
#define ORDER_CALLBACKS_COUNT               8
  ...
  inline currency::blobdata make_offer_sig_blob(const update_offer& uo)
  {
    ...
    epee::string_tools::append_pod_to_strbuff(uo.tx_id, bd);
    epee::string_tools::append_pod_to_strbuff(uo.offer_index, bd);
  ...
  {
    currency::blobdata bd;
    epee::string_tools::append_pod_to_strbuff(co.tx_id, bd);
    epee::string_tools::append_pod_to_strbuff(co.offer_index, bd);
    return bd;
  }
