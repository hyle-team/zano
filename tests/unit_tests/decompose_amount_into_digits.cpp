...
#define TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT 1000000
TEST_F(decompose_amount_into_digits_test, is_correct_23000)
{
  uint64_t expected_chunks_arr[] = { 3000, 20000, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT };
  VEC_FROM_ARR(expected_chunks);
  currency::decompose_amount_into_digits(TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT * 5 + 23000, 0, m_chunk_handler, m_dust_handler, TEST_WALLET_MAX_ALLOWED_OUTPUT_AMOUNT);
