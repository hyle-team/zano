...
hard_fork_4_coinbase_separate_sig_flag::hard_fork_4_coinbase_separate_sig_flag()
{
  REGISTER_CALLBACK_METHOD(hard_fork_4_coinbase_separate_sig_flag, c1);
}

bool hard_fork_4_coinbase_separate_sig_flag::generate(std::vector<test_event_entry>& events) const
{
...
bool hard_fork_4_coinbase_separate_sig_flag::c1(currency::core& c, size_t ev_index, const std::vector<test_event_entry>& events)
{
  return true;
}